...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '0.49.4';

    public string $genVersion = '2.515.0';

    public string $userAgent = 'speakeasy-sdk/php 0.49.4 2.515.0 0.4.0 ian-speakeasy/speakeasy-client-sdk-php';
