...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '0.49.3';

    public string $genVersion = '2.512.4';

    public string $userAgent = 'speakeasy-sdk/php 0.49.3 2.512.4 0.4.0 ian-speakeasy/speakeasy-client-sdk-php';
